                    ...
                    <div class="flex">
                        <div class="ml-3 w-[250px]">
                            ...
                            <div class="grid grid-cols-2 gap-y-2 gap-x-2 mt-1 text-[15px] font-bold">
                                <div id="request" name="status" :style="[request.request_status=='request'?changeColorBy('request'):'']" class="bg-gray-600 text-gray-300 p-2 text-center rounded-lg hover:bg-gray-300 hover:text-gray-600">
                                    Request
                                </div>
                                <div id="open_case" name="status" :style="[request.request_status=='open_case'?changeColorBy('open_case'):'']" class="bg-gray-600 text-gray-300 p-2 text-center rounded-lg hover:bg-gray-300 hover:text-gray-600">
                                    Open Case
                                </div>
                                <div id="in_progress" name="status" :style="[request.request_status=='in_progress'?changeColorBy('in_progress'):'']" class="bg-gray-600 text-gray-300 p-2 text-center rounded-lg hover:bg-gray-300 hover:text-gray-600">
                                    In Progress
                                </div>
                                <div id="finish" name="status" :style="[request.request_status=='finish'?changeColorBy('finish'):'']" class="bg-gray-600 text-gray-300 p-2 text-center rounded-lg hover:bg-gray-300 hover:text-gray-600">
                                    Finish
                                </div>
                            </div>
                        </div>
