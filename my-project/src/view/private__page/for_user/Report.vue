    ...
    <div class="pt-3"> -->
        ...
        <div v-else-if="isSubmitt==true" class="w-[250px] h-fit mx-auto md:w-[500px] lg:w-[1000px] md:h-fit ">
            ...
            <div class="w-fit h-fit mx-auto mt-3 lg:mt-6">
                <button @click="goMain" class="w-fit h-fit p-2 px-6 mx-auto text-[15px] md:text-[20] lg:text-[23px] bg-gray-200 rounded-xl hover:bg-gray-500 hover:text-[#EDEDE9] focus:ring-4 focus:ring-blue-300">
                    กลับไปหน้าหลัก
                </button>
            </div>
