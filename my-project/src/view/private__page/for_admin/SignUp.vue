            ...
            <div class="mt-5">
                <div class="w-[600px] mx-auto p-1 text-[22px]">
                    ...
                    <div class="relative h-[60px]">
                        <h4 v-show="empCode.length > 0"
                            class="text-sm font-semibold text-gray-500 mx-2  transition-opacity fade-in delay-150">
                            Employee code
                            <span class="" :style="[empCode.length == lenghtOfInput.empCodeL ? 'color: rgb(225 29 72);' : '']">
                                {{ empCode.length }}/{{ lenghtOfInput.empCodeL }}
                            </span>
                        </h4>
                        <input v-model="empCode" placeholder="Employee code" id="empCode" type="text"
                            :maxlength="lenghtOfInput.empCodeL"
                            :style="[empCodeS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                            class="absolute bottom-0 w-full h-[40px]  bg-gray-300 text-gray-500   px-2 rounded-lg focus:outline-0">
                    </div>

                    <div class="flex h-fit">
                        <!-- first name -->
                        <div class="relative h-[60px] w-full">
                            <h4 v-show="fName.length > 0"
                                class="text-sm font-semibold text-gray-500 mx-2  transition-opacity fade-in delay-150">
                                First Name
                            ...
                            <input v-model="fName" placeholder="First Name" id="fName" type="text"
                                :maxlength="lenghtOfInput.fNameL"
                                :style="[fNameS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                                class="absolute bottom-0 w-full  h-[40px]  bg-gray-300 text-gray-500   px-2 rounded-lg focus:outline-0">
                        ...
                        <div class="relative h-[60px] w-full ml-1">
                            ...
                            <input v-model="lName" placeholder="Last Name" id="lName" type="text"
                                :maxlength="lenghtOfInput.lNameL"
                                :style="[lNameS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                                class="absolute bottom-0 w-full  h-[40px] bg-gray-300 text-gray-500    px-2 rounded-lg focus:outline-0">
                        ...
                        <div class="static flex w-full ">
                            ...
                            <div class="relative w-full h-[60px] mx-1">
                                ...
                                <select v-model="role" id="role"
                                    :style="[roleS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                                    class="absolute bottom-0 w-full h-[40px]  px-2 bg-gray-300 text-gray-500 rounded-lg focus:outline-0">
                            ...
                            <div class="relative w-full h-[60px] mx-1">
                                ...
                                <input v-model="position" type="text" placeholder="Position"
                                    :maxlength="lenghtOfInput.positionL"
                                    :style="[positionS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                                    class="absolute bottom-0  w-full h-[40px]  px-2 bg-gray-300 text-gray-500 rounded-lg focus:outline-0">
                            ...
                            <div class="relative w-full h-[60px] mx-1">
                                ...
                                <select v-model="office" id="position"
                                    :style="[officeS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                                    class="absolute bottom-0  w-full h-[40px]  px-2 bg-gray-300 text-gray-500 rounded-lg focus:outline-0">
                                    ...
                                    <option value="สำนักบริหารจัดการองค์กรและยุทธศาสตร์">
                                        สำนักบริหารจัดการองค์กรและยุทธศาสตร์</option>
                            ...
                            <div class="relative w-full h-[60px] mx-1">
                                ...
                                <select v-model="group" id="position"
                                    :style="[groupS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                                    class="absolute bottom-0  w-full h-[40px]  px-2 bg-gray-300 text-gray-500 rounded-lg focus:outline-0">
                                    ...
                                    <option value="ส่งเสริมคุณธรรมเครือข่ายทางสังคม">ส่งเสริมคุณธรรมเครือข่ายทางสังคม
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="relative h-[60px] mt-1.5 ">
                        ...
                        <div :style="[emailS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                            class="absolute bottom-0 flex w-full h-[40px]  p-1 bg-gray-300 rounded-lg">
                            <input v-model="email" placeholder="Email" id="email" type="email"
                                :maxlength="lenghtOfInput.emailL"
                                class="w-full h-full mx-1   bg-transparent text-gray-500 focus:outline-0">
                    ...
                    <div class="relative h-[60px] mt-1.5">
                        ...
                        <div class="absolute w-full bottom-0">
                            <div class="relative  ">
                                <input v-model="passW" placeholder="Password" id="pw" type="password"
                                    :maxlength="lenghtOfInput.passWL"
                                    :style="[passWS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                                    class="w-full h-[40px] bg-gray-300 text-gray-500  px-2 rounded-lg focus:outline-0">
                                <img v-show="passW.length > 0" v-if="pd" @click="showPd"
                                    src="../../../assets/password/eye.png" alt="eye"
                                    class="absolute top-[12px] right-[15px] w-[20px] cursor-pointer ">
                                <img v-show="passW.length > 0" v-else @click="showPd" src="../../../assets/password/blind.png"
                                    alt="blind" class="absolute top-[10px] right-[15px] w-[20px] cursor-pointer ">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative  h-[60px] mt-1.5">
                        ...
                        <input v-model="cPassW" placeholder="Confirm Password" id="cPd" type="password"
                            :maxlength="lenghtOfInput.passWL"
                            :style="[cPassWS == false ? 'border-color: rgb(225 29 72);border-width: 2px;' : '']"
                            class="absolute bottom-0 w-full h-[40px] text-gray-500 bg-gray-300   px-2 rounded-lg focus:outline-0">
                    </div>
                ...
                <div class="w-fit mx-auto  mt-10">
                    <button id="submitB" @click="submittform()"
                        class="relative flex w-[200px] h-[40px] p-1 text-[20px] rounded-2xl bg-[#77BEFF] hover:bg-[#6098CC] active:bg-[#C4E3FF]">
...
@keyframes rotate {
    0% {
        transform: v-bind(degree_start);

    }

    100% {
        transform: v-bind(degree_end);
    }
}

@keyframes tada {}</style>