                ...
                <div class="h-[100%] p-3 overflow-y-auto">
                    ...
                    <div v-if="is_edit_open == false">
                        ...
                        <div>
                            <table class="w-full table-fixed mx-auto mt-6 text-[20px]">
                                <tr>
                                    ...
                                    <td :style="[user.user_status == 'inactive' ? 'color:red' : 'color: green']"
                                        class="pt-2 pl-2 indent-[5px] font-semibold text-gray-600 ">
                                        {{ user.user_status }}
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="w-full flex mt-6 mb-1.5" v-if="role == 'super_admin'">
                            <a href="#dele"
                                class="w-[200px] h-[50px] px-5 mx-auto mr-3 text-[15px] font-light text-rose-400 bg-gray-300 rounded-2xl hover:bg-rose-400 hover:text-gray-200">
                                <button class="w-full h-full ">
                                    ลบข้อมูล
                                </button>
                            </a>

                            <button @click="assignDetail(true)"
                                class="w-[200px] h-[50px] px-5 text-[15px]  mx-auto ml-3 font-light text-[#1565C0] bg-gray-300 rounded-2xl hover:bg-[#90CAF9] hover:text-gray-200">
                                แก้ไขข้อมูล
                            </button>
                        </div>
        ...
        <div id="veri" class="overlay ">
            <div class=" verify_s h-96 overflow-hidden rounded-2xl">
                ...
                <div class=" absolute bottom-0 w-full  flex m-auto">
                    ...
                    <button @click="submitEdit(user.userId)"
